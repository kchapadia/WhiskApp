...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const emailActivate = {
    ...
    html: `Hello<strong> ${user.name}</strong>,<br><br><p>Copy the following actiavtion code and paste it into the activation field by clicking on the link below:<p><br><br>${user.temporarytoken}<br><br><a href="http://whiskapp.herokuapp.com/verification">Click here to activate your account.</a>`
    };
...
const sendForgotEmail = asyncHandler(async (req, res) => {
  ...
  if(user)
  {
    ...
    const message = {
      ...
      html: `Hello<strong> ${user.name}</strong>,<br><br><p>Copy the following reset code and paste it into the reset field by clicking on the link below:<p><br><br>${user.temporarytoken}<br><br><br><p><a href="http://whiskapp.herokuapp.com/reset">Click here to reset your password.</a>`, 
    };
